...
| [**getEtudiantConnecte**](TestControlleurApi.md#getetudiantconnecte) | **GET** /api/etudiant/connecte |  |
...
> SucessDTO ajouterEtudiantDansGroupe(retourInvitationDTO)
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **retourInvitationDTO** | [RetourInvitationDTO](RetourInvitationDTO.md) |  | |
...
> SucessDTO envoyerInvitationConversation(retourInvitationDTO)
...
> SucessDTO envoyerInvitationGroupe(retourInvitationDTO)
...
> Array&lt;RetourInvitationDTO&gt; getAllNotificationsFromEtudiant(idEtudiant)
...
[**Array&lt;RetourInvitationDTO&gt;**](RetourInvitationDTO.md)
...
> RetourEtudiantDTO getEtudiantConnecte()
...
import type { GetEtudiantConnecteRequest } from '';
...
async function example() {
  ...
  try {
    const data = await api.getEtudiantConnecte();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> SucessDTO rejoindreConversation(reponseInvitationGroupe)
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **reponseInvitationGroupe** | [ReponseInvitationGroupe](ReponseInvitationGroupe.md) |  | |
