...
import { Activite, RetourEtudiantDTO, RetourGroupeDTO,RetourInvitationDTOTypeEnum,} from "@/src/api/generated";
import { API } from "@/Api";
...
const ERREUR_SEUL_CHEF_AJOUTER_ACTIVITE =
  "Seul le chef peut ajouter une activitée";
const ERREUR_SEUL_CHEF_VIRER = "Seul le chef peut virer un membre";
const ERREUR_NOM_UTILISATEUR_OBLIGATOIRE = "Le nom d'utilisateur est obligatoire";
    ...
    try {
      await API.envoyerInvitationGroupe({
        retourInvitationDTO: {
          ...
          type: RetourInvitationDTOTypeEnum.NouvelleGroupeInvitation,
